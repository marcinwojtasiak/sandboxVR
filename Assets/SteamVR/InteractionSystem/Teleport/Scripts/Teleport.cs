...
namespace Valve.VR.InteractionSystem
{
	...
	public class Teleport : MonoBehaviour
    {
		...
		private Hands pointerHand = null;
		...
		void Update()
		{
			Hands oldPointerHand = pointerHand;
			Hands newPointerHand = null;

			foreach ( Hands hand in player.hands )
			{
				if ( visible )
				{
		...
		//-------------------------------------------------
		private void ShowPointer( Hands newPointerHand, Hands oldPointerHand )
		{
			if ( !visible )
			{
				pointedAtTeleportMarker = null;
		...
		//-------------------------------------------------
		public bool IsEligibleForTeleport( Hands hand )
		{
			if ( hand == null )
			{
				return false;
		...
		//-------------------------------------------------
		private bool WasTeleportButtonReleased( Hands hand )
		{
		...
		//-------------------------------------------------
		private bool IsTeleportButtonDown( Hands hand )
		{
			if ( IsEligibleForTeleport( hand ) )
			{
				if ( hand.noSteamVRFallbackCamera != null )
		...
		//-------------------------------------------------
		private bool WasTeleportButtonPressed( Hands hand )
		{
			if ( IsEligibleForTeleport( hand ) )
			{
				if ( hand.noSteamVRFallbackCamera != null )
		...
		//-------------------------------------------------
		private Transform GetPointerStartTransform( Hands hand )
		{
			if ( hand.noSteamVRFallbackCamera != null )
			{
