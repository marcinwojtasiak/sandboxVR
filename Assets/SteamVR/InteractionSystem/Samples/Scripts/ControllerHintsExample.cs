...
namespace Valve.VR.InteractionSystem.Sample
{
	...
	public class ControllerHintsExample : MonoBehaviour
	{
		...
		//-------------------------------------------------
		public void ShowButtonHints( Hands hand )
		{
		...
		//-------------------------------------------------
		public void ShowTextHints( Hands hand )
		{
		...
		public void DisableHints()
		{
			...
			foreach ( Hands hand in Player.instance.hands )
			{
		...
		//-------------------------------------------------
		private IEnumerator TestButtonHints( Hands hand )
		{
			ControllerButtonHints.HideAllButtonHints( hand );
		...
		//-------------------------------------------------
		private IEnumerator TestTextHints( Hands hand )
		{
			ControllerButtonHints.HideAllTextHints( hand );
