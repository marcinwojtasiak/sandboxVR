...
namespace Valve.VR.InteractionSystem
{
	...
	public class ItemPackageSpawner : MonoBehaviour
	{
		...
		[EnumFlags]
		public Hands.AttachmentFlags attachmentFlags = Hands.defaultAttachmentFlags;
		...
		//-------------------------------------------------
		private void OnHandHoverBegin( Hands hand )
		{
		...
		//-------------------------------------------------
		private void TakeBackItem( Hands hand )
		{
		...
		//-------------------------------------------------
		private ItemPackage GetAttachedItemPackage( Hands hand )
		{
		...
		//-------------------------------------------------
		private void HandHoverUpdate( Hands hand )
		{
		...
		//-------------------------------------------------
		private void OnHandHoverEnd( Hands hand )
		{
		...
		//-------------------------------------------------
		private void RemoveMatchingItemsFromHandStack( ItemPackage package, Hands hand )
		{
            if (hand == null)
                return;
		...
		//-------------------------------------------------
		private void RemoveMatchingItemTypesFromHand( ItemPackage.ItemPackageType packageType, Hands hand )
		{
			for ( int i = 0; i < hand.AttachedObjects.Count; i++ )
			{
				ItemPackageReference packageReference = hand.AttachedObjects[i].attachedObject.GetComponent<ItemPackageReference>();
		...
		//-------------------------------------------------
		private void SpawnAndAttachObject( Hands hand, GrabTypes grabType )
		{
