...
namespace Valve.VR.InteractionSystem
{
    ...
    public class Interactable : MonoBehaviour
    {
        ...
        public delegate void OnAttachedToHandDelegate(Hands hand);
        public delegate void OnDetachedFromHandDelegate(Hands hand);
        ...
        public Hands attachedToHand;

        [System.NonSerialized]
        public Hands hoveringHand;
