...
namespace Valve.VR.InteractionSystem
{
	...
	public class CircularDrive : MonoBehaviour
	{
		...
		private Hands handHoverLocked = null;

        private Interactable interactable;

		//-------------------------------------------------
		private void Freeze( Hands hand )
		{
			frozen = true;
		...
		//-------------------------------------------------
		private IEnumerator HapticPulses( Hands hand, float flMagnitude, int nCount )
		{
			if ( hand != null )
			{
		...
		//-------------------------------------------------
		private void ComputeAngle( Hands hand )
		{
