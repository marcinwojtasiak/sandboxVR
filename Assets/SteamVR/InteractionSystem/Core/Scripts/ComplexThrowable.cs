...
namespace Valve.VR.InteractionSystem
{
	...
	public class ComplexThrowable : MonoBehaviour
	{
		...
		[EnumFlags]
		public Hands.AttachmentFlags attachmentFlags = 0;

		private List<Hands> holdingHands = new List<Hands>();
		...
		//-------------------------------------------------
		private void PhysicsAttach( Hands hand, GrabTypes startingGrabType )
		{
			PhysicsDetach( hand );
		...
		//-------------------------------------------------
		private bool PhysicsDetach( Hands hand )
		{
