...
namespace Valve.VR.InteractionSystem
{
	...
	public class ControllerButtonHints : MonoBehaviour
	{
		...
		//-------------------------------------------------
		private static ControllerButtonHints GetControllerButtonHints( Hands hand )
		{
			if ( hand != null )
			{
		...
		//-------------------------------------------------
		public static void ShowButtonHint( Hands hand, params ISteamVR_Action_In_Source[] actions )
		{
		...
		//-------------------------------------------------
		public static void HideButtonHint( Hands hand, params ISteamVR_Action_In_Source[] actions )
		{
			ControllerButtonHints hints = GetControllerButtonHints( hand );
			if ( hints != null )
			{
		...
		//-------------------------------------------------
		public static void HideAllButtonHints( Hands hand )
		{
			ControllerButtonHints hints = GetControllerButtonHints( hand );
			if ( hints != null )
			{
		...
		//-------------------------------------------------
		public static bool IsButtonHintActive( Hands hand, ISteamVR_Action_In_Source action )
		{
			ControllerButtonHints hints = GetControllerButtonHints( hand );
			if ( hints != null )
			{
		...
		//-------------------------------------------------
		public static void ShowTextHint( Hands hand, ISteamVR_Action_In_Source action, string text, bool highlightButton = true )
        {
            ControllerButtonHints hints = GetControllerButtonHints( hand );
			if ( hints != null )
			{
		...
		//-------------------------------------------------
		public static void HideTextHint( Hands hand, ISteamVR_Action_In_Source action)
		{
			ControllerButtonHints hints = GetControllerButtonHints( hand );
			if ( hints != null )
			{
		...
		//-------------------------------------------------
		public static void HideAllTextHints( Hands hand )
		{
			ControllerButtonHints hints = GetControllerButtonHints( hand );
			if ( hints != null )
			{
		...
		//-------------------------------------------------
		public static string GetActiveHintText( Hands hand, ISteamVR_Action_In_Source action)
		{
			ControllerButtonHints hints = GetControllerButtonHints( hand );
			if ( hints != null )
			{
